...
<body class="Intro" >
    <table width="100%" height="100%" border="0px" cellpadding="0" cellspacing="0">
        ...
        <tr><td colspan="3" class="text" style="text-align: center;font-size: 10px;padding-bottom: 4px;">&copy; 2009-<%=(new DLDateTime()).getDateParts().getYear() %> - Lorenzo González <script>document.write("(lorenzo.profesor"); document.write(" AT "); document.write("gmail.com) ");</script>- v.num_compilacion</td></tr>
    </table>
</body>
</html>
