/*
 * BusinessLogicImplUsuario.java
 *
 * Creado el 21 de mayo de 2007, 8:29
 *
...
import org.elf.datalayer.MessageLevel;

/**
 *
 * @author  <a href="mailto:logongas@users.sourceforge.net">Lorenzo González</a>
 */
public class BusinessLogicImplUsuario extends BusinessLogic {

	/**
	 * Método que se llama después de leer una fila en la base de datos
